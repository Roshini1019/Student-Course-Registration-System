...
public class EmployeeLogin {
    ...
    public EmployeeLogin() {
        ...
        JLabel subtitle = new JLabel("Enter your employee details");
        ...
        loginBtn.addActionListener(e -> loginEmployee());
    ...
    void loginEmployee() {
        try {
            ...
            if (id.isEmpty() || id.equals("Employee ID") || pass.isEmpty() || pass.equals("Password")) {
